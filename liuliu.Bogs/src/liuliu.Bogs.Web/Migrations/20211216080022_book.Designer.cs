...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("liuliu.Bogs.Authorization.Entities.EntityRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Authorization.Entities.EntityUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Authorization.Entities.Module", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("liuliu.Bogs.Authorization.Entities.ModuleFunction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Authorization.Entities.ModuleRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Authorization.Entities.ModuleUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.LoginLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.UserDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.UserLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Infos.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Infos.Entities.MessageReceive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Infos.Entities.MessageReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Systems.Entities.AuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Systems.Entities.AuditOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Systems.Entities.AuditProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("liuliu.Bogs.Authorization.Entities.EntityRole", b =>
                {
                    ...
                    b.HasOne("liuliu.Bogs.Identity.Entities.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("liuliu.Bogs.Authorization.Entities.EntityUser", b =>
                {
                    ...
                    b.HasOne("liuliu.Bogs.Identity.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("liuliu.Bogs.Authorization.Entities.Module", b =>
                {
                    b.HasOne("liuliu.Bogs.Authorization.Entities.Module", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("liuliu.Bogs.Authorization.Entities.ModuleFunction", b =>
                {
                    ...
                    b.HasOne("liuliu.Bogs.Authorization.Entities.Module", "Module")
                        .WithMany()
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.Organization", b =>
                {
                    b.HasOne("liuliu.Bogs.Identity.Entities.Organization", null)
                        .WithMany()
                        .HasForeignKey("ParentId");
                });
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.Role", b =>
                {
                    b.HasOne("liuliu.Bogs.Infos.Entities.Message", null)
            ...
            modelBuilder.Entity("liuliu.Bogs.Identity.Entities.UserDetail", b =>
                {
                    b.HasOne("liuliu.Bogs.Identity.Entities.User", "User")
                        .WithOne("UserDetail")
                        .HasForeignKey("liuliu.Bogs.Identity.Entities.UserDetail", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("liuliu.Bogs.Infos.Entities.Message", b =>
                {
                    b.HasOne("liuliu.Bogs.Identity.Entities.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("liuliu.Bogs.Infos.Entities.MessageReceive", b =>
                {
                    b.HasOne("liuliu.Bogs.Infos.Entities.Message", "Message")
                        .WithMany("Receives")
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("liuliu.Bogs.Infos.Entities.MessageReply", b =>
                {
                    b.HasOne("liuliu.Bogs.Infos.Entities.Message", "BelongMessage")
                        .WithMany()
                        .HasForeignKey("BelongMessageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liuliu.Bogs.Infos.Entities.Message", "ParentMessage")
                        .WithMany("Replies")
                        .HasForeignKey("ParentMessageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("liuliu.Bogs.Infos.Entities.MessageReply", "ParentReply")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("liuliu.Bogs.Systems.Entities.AuditEntity", b =>
                {
                    b.HasOne("liuliu.Bogs.Systems.Entities.AuditOperation", "Operation")
            ...
            modelBuilder.Entity("liuliu.Bogs.Systems.Entities.AuditProperty", b =>
                {
                    b.HasOne("liuliu.Bogs.Systems.Entities.AuditEntity", "AuditEntity")
                        .WithMany("Properties")
